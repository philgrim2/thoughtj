...
import live.thought.thoughtj.protocols.channels.PaymentChannelServerState;
import live.thought.thoughtj.protocols.channels.PaymentChannelV1ServerState;
import live.thought.thoughtj.protocols.channels.PaymentChannelV2ClientState;
import live.thought.thoughtj.protocols.channels.PaymentIncrementAck;
...
import live.thought.thoughtj.protocols.channels.StoredPaymentChannelServerStates;
import live.thought.thoughtj.protocols.channels.StoredServerChannel;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        live.thought.thoughtj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
