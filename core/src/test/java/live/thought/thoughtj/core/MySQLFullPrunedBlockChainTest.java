...
import live.thought.thoughtj.store.MySQLFullPrunedBlockStore;
...
public class MySQLFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest {
    ...
    private static final String DB_NAME = "thoughtj_test";
    private static final String DB_USERNAME = "thoughtj";
