...
import live.thought.thoughtj.store.PostgresFullPrunedBlockStore;
...
public class PostgresFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest
{
    ...
    // You can set up a fresh postgres with the command: create user thoughtj superuser password 'password';
