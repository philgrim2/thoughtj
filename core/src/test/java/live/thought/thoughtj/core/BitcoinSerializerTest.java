...
import live.thought.thoughtj.core.AddressMessage;
...
public class BitcoinSerializerTest {
    ...
    public void testBitcoinPacketHeaderTooShort() {
        new ThoughtSerializer.BitcoinPacketHeader(ByteBuffer.wrap(new byte[] { 0 }));
    }
    ...
    public void testBitcoinPacketHeaderTooLong() {
        ...
        new ThoughtSerializer.BitcoinPacketHeader(ByteBuffer.wrap(wrongMessageLength));
    }
