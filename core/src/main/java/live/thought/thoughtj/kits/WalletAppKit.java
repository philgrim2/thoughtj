...
import live.thought.thoughtj.wallet.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV thoughtj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit thoughtj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing thoughtj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link live.thought.thoughtj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
