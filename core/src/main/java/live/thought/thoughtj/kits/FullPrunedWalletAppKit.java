...
import live.thought.thoughtj.net.discovery.PeerDiscovery;
...
public class FullPrunedWalletAppKit extends AbstractIdleService {
     ...
     * {@link live.thought.thoughtj.core.listeners.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
