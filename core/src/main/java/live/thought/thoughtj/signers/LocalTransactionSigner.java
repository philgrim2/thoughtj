...
package live.thought.thoughtj.signers;
...
import live.thought.thoughtj.script.Script.VerifyFlag;
import live.thought.thoughtj.wallet.KeyBag;
import live.thought.thoughtj.wallet.RedeemData;

/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link live.thought.thoughtj.wallet.KeyBag}.</p>
 ...
 * <p>This signer always uses {@link live.thought.thoughtj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
