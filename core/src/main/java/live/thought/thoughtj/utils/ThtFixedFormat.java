...
import static live.thought.thoughtj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
/**
 * <p>This class, a concrete extension of {@link ThtFormat}, is distinguished in that each
 ...
 * custom pattern using either the {@link ThtFormat.Builder#localizedPattern} or {@link ThtFormat.Builder#localizedPattern} methods, as described in the documentation for the {@link ThtFormat.Builder}
 * class.<ol>
 *
 * <p>A more detailed explanation, including examples, is in the documentation for the
 * {@link ThtFormat} class, and further information beyond that is in the documentation for the
...
public final class ThtFixedFormat extends ThtFormat {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof ThtFixedFormat)) return false;
        ThtFixedFormat other = (ThtFixedFormat)o;
