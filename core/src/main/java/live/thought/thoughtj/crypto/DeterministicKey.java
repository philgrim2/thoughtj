...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link live.thought.thoughtj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
     ...
     * in which case the time is stored alongside the key as per normal, see {@link live.thought.thoughtj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
