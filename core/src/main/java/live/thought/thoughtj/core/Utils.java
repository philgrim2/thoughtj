...
public class Utils {
    ...
    public static live.thought.thoughtj.utils.Pair<Integer, String> splitHostPort(String in) {
        ...
        return new live.thought.thoughtj.utils.Pair<Integer, String>(port, host);
    }
