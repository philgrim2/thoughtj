...
import live.thought.thoughtj.evolution.GetSimplifiedMasternodeListDiff;
import live.thought.thoughtj.evolution.SimplifiedMasternodeListDiff;
import live.thought.thoughtj.governance.GovernanceObject;
import live.thought.thoughtj.governance.GovernanceSyncMessage;
import live.thought.thoughtj.governance.GovernanceVote;
import live.thought.thoughtj.governance.GovernanceVoteConfidence;
import live.thought.thoughtj.net.StreamConnection;
import live.thought.thoughtj.store.BlockStore;
import live.thought.thoughtj.store.BlockStoreException;
import live.thought.thoughtj.utils.ListenerRegistration;
 ...
 * {@link live.thought.thoughtj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link live.thought.thoughtj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link live.thought.thoughtj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link live.thought.thoughtj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link live.thought.thoughtj.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // thoughtj is a client mode implementation. That means there's not much point in us talking to other client
...
//            if(!instantSend.mapTxLockVotes.containsKey(item.hash))
     ...
     * Once the pong is received the value returned by {@link live.thought.thoughtj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link live.thought.thoughtj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link live.thought.thoughtj.core.Peer#ping()} has never
