 ...
 *
 * <p>TransactionConfidence is updated via the {@link live.thought.thoughtj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link live.thought.thoughtj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link live.thought.thoughtj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link live.thought.thoughtj.core.TransactionConfidence#getConfidenceType()}
            ...
            SEEN_PEERS,
            /**
             * Occurs when the type returned by {@link live.thought.thoughtj.core.TransactionConfidence#getIXType()}
     ...
     * and so on. This information is useful for {@link live.thought.thoughtj.wallet.CoinSelector} implementations to risk analyze
