 ...
 * </ul>
 */
public class ThoughtSerializer extends MessageSerializer {
    private static final Logger log = LoggerFactory.getLogger(ThoughtSerializer.class);
    ...
    /**
     * Constructs a ThoughtSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     * @param parseRetain      retain the backing byte array of a message for fast reserialization.
     */
    public ThoughtSerializer(NetworkParameters params, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("ThoughtSerializer doesn't currently know how to serialize " + message.getClass());
        }
     ...
     * {@link ThoughtSerializer#deserializeHeader}.
     */
    @Override
