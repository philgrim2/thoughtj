...
import live.thought.thoughtj.net.discovery.HttpDiscovery;
import live.thought.thoughtj.params.*;
...
public abstract class NetworkParameters {
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link live.thought.thoughtj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link live.thought.thoughtj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link live.thought.thoughtj.core.DumpedPrivateKey}. */
     ...
     */
    public abstract ThoughtSerializer getSerializer(boolean parseRetain);
