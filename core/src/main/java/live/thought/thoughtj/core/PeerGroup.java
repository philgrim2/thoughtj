...
import live.thought.thoughtj.governance.GovernanceVote;
import live.thought.thoughtj.governance.GovernanceVoteBroadcast;
import live.thought.thoughtj.governance.GovernanceVoteBroadcaster;
import live.thought.thoughtj.governance.GovernanceVoteConfidence;
import live.thought.thoughtj.net.*;
import live.thought.thoughtj.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster, GovernanceVoteBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of thoughtj fixes the known
     ...
     * {@link live.thought.thoughtj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link live.thought.thoughtj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link live.thought.thoughtj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link live.thought.thoughtj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link live.thought.thoughtj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link live.thought.thoughtj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link live.thought.thoughtj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link live.thought.thoughtj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link live.thought.thoughtj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a thoughtj based app running in SPV mode to fully validating security.
     */
