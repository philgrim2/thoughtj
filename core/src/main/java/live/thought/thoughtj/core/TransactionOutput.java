...
public class TransactionOutput extends ChildMessage {
    ...
    public TransactionOutput(NetworkParameters params, @Nullable Transaction parent, Coin value, byte[] scriptBytes) {
        ...
        checkArgument(value.signum() >= 0 || value.equals(Coin.NEGATIVE_NOTION), "Negative values not allowed");
     ...
     *
     * <p>You probably should use {@link live.thought.thoughtj.core.TransactionOutput#getMinNonDustValue()} which uses
