...
public class BlockChain extends AbstractBlockChain {
     ...
     *
     * <p>For the store, you should use {@link live.thought.thoughtj.store.SPVBlockStore} or you could also try a
     * {@link live.thought.thoughtj.store.MemoryBlockStore} if you want to hold all headers in RAM and don't care about
