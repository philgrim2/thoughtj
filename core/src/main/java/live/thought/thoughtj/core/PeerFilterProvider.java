 ...
 * Note that an implementer is responsible for calling {@link PeerGroup#recalculateFastCatchupAndFilter(live.thought.thoughtj.core.PeerGroup.FilterRecalculateMode)}
