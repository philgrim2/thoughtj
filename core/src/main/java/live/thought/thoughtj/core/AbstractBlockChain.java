 ...
 * the lightweight SPV mode, a {@link live.thought.thoughtj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link live.thought.thoughtj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            if (storedPrev == null) {
                ...
                params.checkDifficulty(storedPrev, block, blockStore);
