...
public class Script {
     ...
     *
     * <p>thoughtj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
     ...
     * {@link live.thought.thoughtj.core.TransactionInput#verify(live.thought.thoughtj.core.TransactionOutput)} or
     * {@link live.thought.thoughtj.script.Script#correctlySpends(live.thought.thoughtj.core.Transaction, long, Script)}. This method
     * is useful if you need more precise control or access to the final state of the stack. This interface is very
     * likely to change in future.
     *
     * @deprecated Use {@link #executeScript(live.thought.thoughtj.core.Transaction, long, live.thought.thoughtj.script.Script, java.util.LinkedList, java.util.Set)}
     * instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@link #correctlySpends(live.thought.thoughtj.core.Transaction, long, live.thought.thoughtj.script.Script, java.util.Set)}
    ...
    /**
     * Get the {@link live.thought.thoughtj.script.Script.ScriptType}.
