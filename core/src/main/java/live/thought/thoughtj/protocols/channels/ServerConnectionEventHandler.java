...
public abstract class ServerConnectionEventHandler {
     ...
     * {@link StoredPaymentChannelServerStates#getChannel(live.thought.thoughtj.core.Sha256Hash)} with the id provided in
     * {@link ServerConnectionEventHandler#channelOpen(live.thought.thoughtj.core.Sha256Hash)}</p>
     */
