...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     *                   See {@link live.thought.thoughtj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
     ...
     * {@link ClientConnection#destroyConnection(live.thought.thoughtj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
