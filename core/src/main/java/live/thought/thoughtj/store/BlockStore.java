...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link live.thought.thoughtj.core.BlockChain#getChainHead()}
     * or perhaps {@link live.thought.thoughtj.core.BlockChain#getBestChainHeight()} which will run in constant time and
    ...
    /**
     * Get the {@link live.thought.thoughtj.core.NetworkParameters} of this store.
