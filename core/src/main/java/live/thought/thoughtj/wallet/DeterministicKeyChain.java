...
import live.thought.thoughtj.core.BloomFilter;
 ...
 * {@link live.thought.thoughtj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link live.thought.thoughtj.crypto.MnemonicCode},
 ...
 * {@link live.thought.thoughtj.crypto.DeterministicKey#serializePubB58(live.thought.thoughtj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link live.thought.thoughtj.crypto.DeterministicKey#deserializeB58(live.thought.thoughtj.crypto.DeterministicKey, String, live.thought.thoughtj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(live.thought.thoughtj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link live.thought.thoughtj.crypto.DeterministicHierarchy} and
 * {@link live.thought.thoughtj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     *  Using {@link live.thought.thoughtj.crypto.KeyCrypter KeyCrypter} to decrypt.
     */
    protected DeterministicKeyChain(DeterministicSeed seed, @Nullable KeyCrypter crypter,
     ...
     * The returned key can be serialized and then passed into {@link #watch(live.thought.thoughtj.crypto.DeterministicKey)}
     ...
     * @see live.thought.thoughtj.wallet.MarriedKeyChain
     */
