...
package live.thought.thoughtj.wallet.listeners;
...
public interface WalletCoinsReceivedEventListener {
     ...
     * the object retrieved via {@link live.thought.thoughtj.core.Transaction#getConfidence()}. It's safe to modify the
