...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link live.thought.thoughtj.wallet.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the thoughtj protobuf format. */
     ...
     *
     * <p>See the docs for {@link live.thought.thoughtj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
