...
/**
 * <p>A KeyChainGroup is used by the {@link live.thought.thoughtj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws live.thought.thoughtj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link live.thought.thoughtj.crypto.KeyCrypterScrypt}.
     *
     * @throws live.thought.thoughtj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
