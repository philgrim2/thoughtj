...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link live.thought.thoughtj.crypto.MnemonicCode} for more
     ...
     *
     * @throws live.thought.thoughtj.crypto.MnemonicException if check fails
     */
