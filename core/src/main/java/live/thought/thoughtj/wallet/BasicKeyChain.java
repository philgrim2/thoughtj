...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws live.thought.thoughtj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws live.thought.thoughtj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(live.thought.thoughtj.crypto.KeyCrypter,
