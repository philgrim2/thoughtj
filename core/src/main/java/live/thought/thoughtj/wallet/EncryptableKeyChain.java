...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(live.thought.thoughtj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link live.thought.thoughtj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link live.thought.thoughtj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
