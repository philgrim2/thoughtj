...
import live.thought.thoughtj.signers.*;
import live.thought.thoughtj.utils.*;
import live.thought.thoughtj.wallet.Protos.Wallet.*;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, live.thought.thoughtj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link live.thought.thoughtj.wallet.DeterministicKeyChain#ACCOUNT_ZERO_PATH 0 hardened path}
     */
     ...
     * {@link live.thought.thoughtj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(live.thought.thoughtj.wallet.KeyChain.KeyPurpose)} with
     * {@link live.thought.thoughtj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(live.thought.thoughtj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(live.thought.thoughtj.wallet.KeyChain.KeyPurpose)} with
     * {@link live.thought.thoughtj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link live.thought.thoughtj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link live.thought.thoughtj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(live.thought.thoughtj.wallet.KeyChain.KeyPurpose)} with
     * {@link live.thought.thoughtj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(live.thought.thoughtj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(live.thought.thoughtj.wallet.KeyChain.KeyPurpose)} with
     * {@link live.thought.thoughtj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, live.thought.thoughtj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link live.thought.thoughtj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link live.thought.thoughtj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link live.thought.thoughtj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws live.thought.thoughtj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(live.thought.thoughtj.crypto.KeyCrypter,
     ...
     * {@link live.thought.thoughtj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link live.thought.thoughtj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link live.thought.thoughtj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link live.thought.thoughtj.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable live.thought.thoughtj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws live.thought.thoughtj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
