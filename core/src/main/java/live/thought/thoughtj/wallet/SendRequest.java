...
import live.thought.thoughtj.wallet.KeyChain.KeyPurpose;
import live.thought.thoughtj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link live.thought.thoughtj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link live.thought.thoughtj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
